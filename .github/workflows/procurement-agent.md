...
2. Prepare your environment by running `pip install pypdf` using the bash tool. (Network access to the Python ecosystem has been explicitly granted).
...
5. Read all supporting rule files: `instructions/INSTRUCTIONS.md`, `instructions/REGISTER.md`, `instructions/EXCEPTIONS.md`, and `instructions/OUTPUT_JSON.md`.
